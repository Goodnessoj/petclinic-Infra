...
cluster. It also waits for platform ACM certificates to detach from ALB listeners
so certificate deletion does not race the AWS Load Balancer Controller cleanup.
